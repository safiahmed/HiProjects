...
$product = new Users();
$data = array();
$product_details=$product->productkit_details($data);
 foreach ($product_details as $prod){
$cat_id_index=$prod['cat_id_fk'];
}
                            ...
                            <div class="col2-left-layout">
                                <div class="col-main">
                                    ...
                                    <div class="middle_boxes">
                                        <?php include 'projectkitcategory-grid-view.php'; ?>
                                        <div id="list-view">
                                            <?php include 'projectkitcategory-list-view.php'; ?> 
                                        </div>
                                    </div>
                                </div>
